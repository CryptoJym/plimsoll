...
const RECORD_STRING_KEYS: Array<readonly [string, MetadataStringKind]> = [
  ...
  ["permissionMode", "classification"],
  ["permission_mode", "classification"],
  ["subagentType", "classification"],
  ["subagent_type", "classification"],
  ["cancelledBy", "classification"],
  ["cancelled_by", "classification"],
  ["cancelTrigger", "classification"],
  ["cancel_trigger", "classification"],
