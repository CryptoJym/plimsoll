"""Shared helpers for the round-5 to round-10 (B0, eco-6hoxj.164.4, rounds 1-4) fixtures.

Every fixture is a standalone script: `python3 <fixture>.py --rule r4|r5|r6|r7|r8|r9|r10`.
...
`--rule r6`, `r7`, `r8` and `r9` and green under `--rule r10` (exit 1 = RED, exit 0 = GREEN).
...
def rule_arg() -> str:
    ...
    p.add_argument("--rule", choices=("r4", "r5", "r6", "r7", "r8", "r9", "r10"), required=True, help="which round's rule to apply")
