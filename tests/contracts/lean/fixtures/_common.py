"""Shared helpers for the round-5 to round-13 (B0, eco-6hoxj.164.4, rounds 1-7) fixtures.

Every fixture is a standalone script: `python3 <fixture>.py --rule r4|r5|r6|r7|r8|r9|r10|r11|r12|r13`.
...
red under `--rule r6`, `r7`, `r8`, `r9`, `r10`, `r11` and `r12` and green under `--rule r13` (exit 1 = RED, exit 0 = GREEN).
...
def rule_arg() -> str:
    ...
    p.add_argument("--rule", choices=("r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12", "r13"), required=True, help="which round's rule to apply")
