...
These tests bind the lean-Plimsoll contracts (`docs/lean/CONTRACTS.md`, round 11 = B0 round 5, with the ARCHITECTURE, BUDGETS,
...
`stamp_from_other_ledger` parking only the refused rows until the ledger is linked or an admin releases them, C1/C4), `membership` (B2a), `runway`
