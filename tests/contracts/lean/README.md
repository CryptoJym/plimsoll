...
These tests bind the lean-Plimsoll contracts (`docs/lean/CONTRACTS.md`, round 10 = B0 round 4, with the ARCHITECTURE, BUDGETS,
...
with a fake cloud, the pre-B2a seed, the partial join, the echo's install, the flood split, C1/C4), `membership` (B2a), `runway`
